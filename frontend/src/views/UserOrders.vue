...
// GSAP 动画已禁用（from opacity:0 导致内容不可见的 bug）
// 入场动画改用 CSS .animate-up (fadeInUp keyframes)
...
.order-card {
  ...
  box-shadow: 0 2px 8px rgba(32, 38, 51, 0.04);
  transition: all 0.25s ease;
  &:hover { box-shadow: 0 8px 24px rgba(32, 38, 51, 0.08); transform: translateY(-2px); border-color: #e0e3e9; }

  .card-header {
    display: flex; justify-content: space-between; align-items: center; padding-bottom: 14px; border-bottom: 1px dashed #e8eaef; margin-bottom: 14px;
    .shop-info { display: flex; align-items: center; gap: 8px; cursor: pointer; font-size: 14px; font-weight: 700; color: #202633; &:hover { opacity: 0.8; } }
    .status-badge { font-size: 13px; font-weight: 700; display: inline-flex; align-items: center; gap: 5px; padding: 4px 10px; border-radius: 99px; background: #f6f7f9;
      &.wait { color: #ff5000; background: #fff2f0; }
      &.success { color: #31a45f; background: #f0faf4; }
      &.cancel { color: #8c92a0; background: #f4f5f7; }
  ...
  .card-body {
    ...
    .img-box { width: 90px; height: 90px; border-radius: 12px; overflow: hidden; background: #f4f5f7; border: 1px solid #eceef2; flex-shrink: 0;
      .prod-img { width: 100%; height: 100%; transition: transform 0.3s; object-fit: cover; &:hover { transform: scale(1.05); } }
      .err-slot { width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; background: #f2f4f8; }
    }
    .info-box { flex: 1; min-width: 0;
      .prod-title { font-size: 15px; font-weight: 700; color: #202633; margin-bottom: 6px; line-height: 1.45; max-height: 44px; overflow: hidden; }
      .prod-desc { font-size: 13px; color: #8c92a0; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin-bottom: 10px; }
      .tags .tag { font-size: 11px; background: #fff9e6; color: #b57b08; padding: 3px 8px; border-radius: 6px; margin-right: 6px; display: inline-flex; align-items: center; gap: 4px; font-weight: 600; }
    }
    .price-box { text-align: right; flex-shrink: 0;
      .price { font-weight: 800; font-size: 17px; color: #202633; .symbol { font-size: 13px; margin-right: 1px; } }
      .qty { font-size: 12px; color: #9aa3b2; margin-top: 4px; }
    }
  }

  .card-footer {
    display: flex; justify-content: space-between; align-items: center; margin-top: 18px; padding-top: 14px; border-top: 1px solid #f2f3f5;
    .total-info { font-size: 13px; color: #646f7e; font-weight: 500; .amount { font-size: 18px; font-weight: 800; color: #ff5000; margin-left: 4px; } }
    .actions {
      display: flex; gap: 10px; flex-wrap: wrap; justify-content: flex-end;
      .btn { padding: 8px 20px; border-radius: 99px; font-size: 13px; cursor: pointer; border: 1px solid #dce0e6; background: #fff; font-weight: 600; transition: 0.2s; display: inline-flex; align-items: center; gap: 5px; }
      .btn-contact { color: #5c6575; &:hover { border-color: #202633; color: #202633; background: #f9fafb; } }
      .btn-primary { border: none; background: #202633; color: #ffdf5d; &:hover { background: #11151d; transform: translateY(-1px); box-shadow: 0 6px 16px rgba(32,38,51,0.2); } }
      .btn-confirm { border-color: #ffdf5d; color: #b57b08; background: #fffbe6; &:hover { background: #fff1b8; } }
      .btn-outline { color: #646f7e; &:hover { background: #f4f5f7; border-color: #c3cad6; } }
    }
  }
}
...
.animate-up { animation: fadeInUp 0.5s cubic-bezier(0.22, 1, 0.36, 1) both; }
@keyframes fadeInUp {
